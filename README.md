# Sistema de Gestión de Model.Garage
...
- **Gestión de Espacios**: Cada vehículo ocupa un espacio específico (Model.Moto: 1, Model.Auto: 2, Camión: 4).
...
3. Ejecutar la clase `Model.Main.java`.
